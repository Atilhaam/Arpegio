...
public final class ItemCardNode: ASCellNode {
    ...
    private let postImageNode: ASImageNode = {
        ...
        postImageNode.contentMode = .scaleToFill
//        postImageNode.layer.cornerRadius = 5
...
//        }
    ...
    public override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        return ASInsetLayoutSpec(insets: .init(top: 8, left: 8, bottom: 8, right: 8), child: finalStack)
    }
